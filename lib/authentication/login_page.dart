...
class Login extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => LoginProvider()..loginCheck()),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('lib/assets/images/mainlogo.jpeg'),
                    fit: BoxFit.cover,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (provider.firstLogin == true) ...[
                                        _buildClassicTextField(
                                          ...
                                          validator: (value) {
                                            ...
                                            if (!newReg.hasMatch(value)) {
                                              return 'Enter a valid URL (e.g., https://192.168.104.15:8018)';
                                            }
                                            return null;
                                          },
                                          enabled: !provider.disableFields && !provider.isLoadingDatabases,
                                          suffix: IconButton(
                                            icon: Icon(
                                              Icons.refresh,
                                              color: Theme.of(context).primaryColor,
                                            ...
                                            onPressed: provider.isLoadingDatabases
                                              ...
                                              ScaffoldMessenger.of(context).showSnackBar(
                                                SnackBar(
                                                  content: Text('Fetching databases...'),
                                        ...
                                        if (provider.errorMessage != null && !provider.isLoadingDatabases)
                                          Padding(
                                            padding: const EdgeInsets.symmetric(vertical: 8.0),
                                            child: Text(
                                        ...
                                        DropdownButtonFormField<String>(
                                          ...
                                          items: provider.urlCheck && provider.dropdownItems.isNotEmpty
                                              ? provider.dropdownItems
                                              : [],
                                          onChanged: (provider.disableFields || provider.isLoadingDatabases)
                                              ? null
